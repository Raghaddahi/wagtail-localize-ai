...
def translate_text(text: StringValue, source_language: str, target_language: str):
    ...
    SYSTEM_PROMPT = (
        ...
        "Always wrap every UI label, button, menu item, and field name in the "
        "target language's typographic quotation marks — without exception. In "
        "Arabic and French use guillemets « » (e.g. «الصور», «إضافة», «إنشاء», "
        "«الخصوصية», «المجموعات»), even for single-word labels. Use the matching "
        "established convention for other languages.\n"
